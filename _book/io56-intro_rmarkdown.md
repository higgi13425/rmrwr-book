...
```{=html}
<div id="qvzlgksopj" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#qvzlgksopj table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#qvzlgksopj thead, #qvzlgksopj tbody, #qvzlgksopj tfoot, #qvzlgksopj tr, #qvzlgksopj td, #qvzlgksopj th {
  border-style: none;
}
...
#qvzlgksopj .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#qvzlgksopj .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#qvzlgksopj .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#qvzlgksopj .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#qvzlgksopj .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#qvzlgksopj .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#qvzlgksopj .gt_spanner_row {
  border-bottom-style: hidden;
}

#qvzlgksopj .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#qvzlgksopj .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#qvzlgksopj .gt_from_md > :first-child {
  margin-top: 0;
}

#qvzlgksopj .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#qvzlgksopj .gt_row_group_first td {
  border-top-width: 2px;
}

#qvzlgksopj .gt_row_group_first th {
  border-top-width: 2px;
}

#qvzlgksopj .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#qvzlgksopj .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#qvzlgksopj .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#qvzlgksopj .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#qvzlgksopj .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#qvzlgksopj .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#qvzlgksopj .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#qvzlgksopj .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#qvzlgksopj .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#qvzlgksopj .gt_font_normal {
  font-weight: normal;
}

#qvzlgksopj .gt_font_bold {
  font-weight: bold;
}

#qvzlgksopj .gt_font_italic {
  font-style: italic;
}
...
#qvzlgksopj .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#qvzlgksopj .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#qvzlgksopj .gt_indent_1 {
  text-indent: 5px;
}

#qvzlgksopj .gt_indent_2 {
  text-indent: 10px;
}

#qvzlgksopj .gt_indent_3 {
  text-indent: 15px;
}

#qvzlgksopj .gt_indent_4 {
  text-indent: 20px;
}

#qvzlgksopj .gt_indent_5 {
  text-indent: 25px;
}

#qvzlgksopj .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#qvzlgksopj div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
...
<div class='webex-radiogroup' id='radio_MKZHTAZJSB'><label><input type="radio" autocomplete="off" name="radio_MKZHTAZJSB" value="answer"></input> <span>r covid %>%  mean(ct_result, na.rm = TRUE) %>% format(digits = 5)</span></label><label><input type="radio" autocomplete="off" name="radio_MKZHTAZJSB" value=""></input> <span>r covid %>% median(ct_result, na.rm = TRUE) %>% format(digits = 7)</span></label><label><input type="radio" autocomplete="off" name="radio_MKZHTAZJSB" value=""></input> <span>r covid %>%  sd(ct_result, na.rm=TRUE) %>% format(digits =3)</span></label></div>

<br>

The standard deviation of the cycle threshold in this study was
<div class='webex-radiogroup' id='radio_BXVWWOCHUG'><label><input type="radio" autocomplete="off" name="radio_BXVWWOCHUG" value=""></input> <span>r covid %>%  mean(ct_result, na.rm = TRUE) %>% format(digits = 5)</span></label><label><input type="radio" autocomplete="off" name="radio_BXVWWOCHUG" value=""></input> <span>r covid %>% median(ct_result, na.rm = TRUE) %>% format(digits = 7)</span></label><label><input type="radio" autocomplete="off" name="radio_BXVWWOCHUG" value="answer"></input> <span>r covid %>%  sd(ct_result, na.rm=TRUE) %>% format(digits =3)</span></label></div>
