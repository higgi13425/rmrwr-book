...
<div class="tutorial-exercise" data-label="pipe-hunt" data-caption="Code" data-completion="1" data-diagnostics="1" data-startover="1" data-lines="0">
...
<!--html_preserve-->
<script type="application/shiny-prerendered" data-context="server">
`tutorial-exercise-pipe-hunt-result` <- learnr:::setup_exercise_handler(reactive(req(input$`tutorial-exercise-pipe-hunt-code-editor`)), session)
output$`tutorial-exercise-pipe-hunt-output` <- renderUI({
  `tutorial-exercise-pipe-hunt-result`()
})
</script>
<!--/html_preserve-->
<!--html_preserve-->
<script type="application/shiny-prerendered" data-context="server">
`tutorial-exercise-pipe-fix-result` <- learnr:::setup_exercise_handler(reactive(req(input$`tutorial-exercise-pipe-fix-code-editor`)), session)
output$`tutorial-exercise-pipe-fix-output` <- renderUI({
  `tutorial-exercise-pipe-fix-result`()
})
</script>
<!--/html_preserve-->
<!--html_preserve-->
<script type="application/shiny-prerendered" data-context="server">
`tutorial-exercise-plot-debug-result` <- learnr:::setup_exercise_handler(reactive(req(input$`tutorial-exercise-plot-debug-code-editor`)), session)
output$`tutorial-exercise-plot-debug-output` <- renderUI({
  `tutorial-exercise-plot-debug-result`()
})
</script>
<!--/html_preserve-->
<!--html_preserve-->
<script type="application/shiny-prerendered" data-context="server">
`tutorial-exercise-pipe-debug-2-result` <- learnr:::setup_exercise_handler(reactive(req(input$`tutorial-exercise-pipe-debug-2-code-editor`)), session)
output$`tutorial-exercise-pipe-debug-2-output` <- renderUI({
  `tutorial-exercise-pipe-debug-2-result`()
})
</script>
<!--/html_preserve-->
<!--html_preserve-->
<script type="application/shiny-prerendered" data-context="server">
`tutorial-exercise-plot-debug-2-result` <- learnr:::setup_exercise_handler(reactive(req(input$`tutorial-exercise-plot-debug-2-code-editor`)), session)
output$`tutorial-exercise-plot-debug-2-output` <- renderUI({
  `tutorial-exercise-plot-debug-2-result`()
})
</script>
<!--/html_preserve-->
<!--html_preserve-->
<script type="application/shiny-prerendered" data-context="server">
`tutorial-exercise-plot-debug-3-result` <- learnr:::setup_exercise_handler(reactive(req(input$`tutorial-exercise-plot-debug-3-code-editor`)), session)
output$`tutorial-exercise-plot-debug-3-output` <- renderUI({
  `tutorial-exercise-plot-debug-3-result`()
})
</script>
<!--/html_preserve-->
<!--html_preserve-->
<script type="application/shiny-prerendered" data-context="server">
`tutorial-exercise-pipe-debug-3-result` <- learnr:::setup_exercise_handler(reactive(req(input$`tutorial-exercise-pipe-debug-3-code-editor`)), session)
output$`tutorial-exercise-pipe-debug-3-output` <- renderUI({
  `tutorial-exercise-pipe-debug-3-result`()
})
</script>
<!--/html_preserve-->
