...
```{=html}
<div id="rbpfrsujvz" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#rbpfrsujvz table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}

#rbpfrsujvz thead, #rbpfrsujvz tbody, #rbpfrsujvz tfoot, #rbpfrsujvz tr, #rbpfrsujvz td, #rbpfrsujvz th {
  border-style: none;
}
...
#rbpfrsujvz .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#rbpfrsujvz .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#rbpfrsujvz .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#rbpfrsujvz .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#rbpfrsujvz .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#rbpfrsujvz .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#rbpfrsujvz .gt_spanner_row {
  border-bottom-style: hidden;
}

#rbpfrsujvz .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#rbpfrsujvz .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#rbpfrsujvz .gt_from_md > :first-child {
  margin-top: 0;
}

#rbpfrsujvz .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#rbpfrsujvz .gt_row_group_first td {
  border-top-width: 2px;
}

#rbpfrsujvz .gt_row_group_first th {
  border-top-width: 2px;
}

#rbpfrsujvz .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#rbpfrsujvz .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#rbpfrsujvz .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#rbpfrsujvz .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#rbpfrsujvz .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#rbpfrsujvz .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#rbpfrsujvz .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#rbpfrsujvz .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#rbpfrsujvz .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#rbpfrsujvz .gt_font_normal {
  font-weight: normal;
}

#rbpfrsujvz .gt_font_bold {
  font-weight: bold;
}

#rbpfrsujvz .gt_font_italic {
  font-style: italic;
}
...
#rbpfrsujvz .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}

#rbpfrsujvz .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#rbpfrsujvz .gt_indent_1 {
  text-indent: 5px;
}

#rbpfrsujvz .gt_indent_2 {
  text-indent: 10px;
}

#rbpfrsujvz .gt_indent_3 {
  text-indent: 15px;
}

#rbpfrsujvz .gt_indent_4 {
  text-indent: 20px;
}

#rbpfrsujvz .gt_indent_5 {
  text-indent: 25px;
}

#rbpfrsujvz .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}

#rbpfrsujvz div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
...
Let's try to extract some data from a CDC PDF. Get the pdf from the code chunk below. Tables are on pages 26-51. You may want to find the PDF on the web at https://www.cdc.gov/nchs/data/hus/hus19-508.pdf to help you pick out an interesting table.
Note that the page numbers within the pdf do not correspond to the actual page numbers inof the document. You may have to add 11 to the listed page number the get the actual page/table. 

``` r
cdc_pdf <- "https://www.cdc.gov/nchs/data/hus/hus19-508.pdf"
```

Pick out a table that you find interesting, and try to extract it and clean it up to raw data. Try doing one table programmatically, and (a harder one) interactively. The side-by-side ones on pages 47-48 (which are really 58-59) may be good examples for interactive extraction. See if you can get all50 states into one table. 
