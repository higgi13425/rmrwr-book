...
Then copy the code below into a code chunk in your quarto file, and run it to read in the data.
```{r cal_data, results='hide', fig.keep='all', message = FALSE}
...
```{r cal-pop, results='hide', fig.keep='all', message = FALSE}
...
```{r us-counties,  results='hide', fig.keep='all', message = FALSE}
us_counties <- get_acs(
  geography = "county",
  variables = "B01003_001", # Total population variable
...
```{r nat-health-data, results='hide', fig.keep='all', message = FALSE}
...
```{r  a2, results='hide', fig.keep='all', message = FALSE}
library(mapboxapi)
library(tigris)
library(tidyverse)
library(sf)
...
```{r chop, results='hide', fig.keep='all', message = FALSE}
philly_tracts <- 
...
```{r la, results='hide', fig.keep='all', message = FALSE}
library(mapboxapi)
library(tidyverse)
library(tigris)
library(sf)
