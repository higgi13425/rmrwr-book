...
There also are simply not enough statisticians to meet the needs of medical science. Having clinicians on the front lines with some data science training makes a big difference, whether in historical contexts in London (John Snow) or modern settings in Flint, Michigan (Mona Hanna-Atisha). Having more clinicians with some training will impact medical care, as they will identify local problems that would have otherwise never reached a statistician, and probably never been addressed with data otherwise. 
...
### Not Comprehensive Coverage of R
This book is also far from comprehensive in teaching what is available in the R ecosystem. Many of the later chapters will be launching pads, giving you a taste of what is available un cerain areas, and guiding you to resources that you can explore to learn and do more.
