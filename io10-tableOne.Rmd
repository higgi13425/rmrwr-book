...
<br>
Before we plunge in, I would like to make one point of warning. It is quite common in a N-arm randomized controlled trial to compare the distribution of particular baseline characteristics of the subjects between arms with a p value, usually in a column at the far right. This is silly, as there is a whole column of p values, corresponding to multiple comparisons. With 20 comparisons, by chance, you are likely to get one or more "significant" p values. These are not helpful or meaningful, and are considered bad statistical practice.     
<br>
