...
To fold (hide) your code with an option for the user to click on a `Code button` to see it, set up your YAML chunk at the top of the qmd document with the html option of `code-fold: true`.
