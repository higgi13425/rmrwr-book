...
`r webexercises::mcq(c("B2:F8", answer = 'A4:F11', 'A1:L30', 'B4:K15'))`
...
`r webexercises::mcq(c('baseline_esr', answer = 'improved', 'patient_id'))`

- which variable is the dbl numeric data type?

`r webexercises::mcq(c('arm', 'patient_id', answer = 'rad_num'))`
...
`r webexercises::mcq(c('25 drops', answer = '1 quart per day', 'one-half rood'))`
...
`r webexercises::mcq(c(answer = 'print(x, width=Inf)', 'filter(starts_with("width"))','sum(na.rm=TRUE)'))`

- What function (and argument) let you print all the *rows* of a tibble?

`r webexercises::mcq(c('filter(ends_with("all"))','median(na.rm=TRUE)', answer = 'print(x, n=Inf)'))`
...
`r webexercises::mcq(c('52', answer = '59', '48'))`

- What proportion of subjects in strep_tb were improved? 

`r webexercises::mcq(c('0.493', answer = '50.514', '0.55'))`

- What is the mean value for rad_num in strep_tb? 

`r webexercises::mcq(c(answer = '3.93', '1.89', '4.7'))`
...
`r webexercises::mcq(c('10,000', answer = '1,391', '107'))`
