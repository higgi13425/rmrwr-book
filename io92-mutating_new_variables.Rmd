...
visit 2?\
`r webexercises::mcq(c("Participant 001", "Participant 002", answer = "Participant 003", "Participant 004"))`\
...
`r webexercises::mcq(c("Participant 001", "Participant 002", "Participant 003", answer = "Participant 004"))`
:::
...
`r hide('Show/Hide the Solution')` Note that `round`ing to 2 places was
